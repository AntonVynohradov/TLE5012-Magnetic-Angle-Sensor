...
public:
    ...
    static AddressField_t const addrFields[];  //!< \brief Registers bitfields
    ...
    void setSlaveNumber(uint8_t const snr);
...
private:
    static BitField_t const bitFields[];  //!< \brief Registers bitfields
